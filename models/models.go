...
type Product struct {
	ID          bson.ObjectID `bson:"_id,omitempty"` // MongoDB's unique identifier for the product
...
type Address struct {
	ID         bson.ObjectID `bson:"_id,omitempty"` // MongoDB's unique identifier for the address
...
type Order struct {
	ID            bson.ObjectID `bson:"_id,omitempty"` // MongoDB's unique identifier for the order
...
type Payment struct {
	ID      bson.ObjectID `bson:"_id,omitempty"` // MongoDB's unique identifier for the payment
